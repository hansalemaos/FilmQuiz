...
- Generate exercises from movie titles
- Uses IMDB Database
...
| -------------------------------------------------------------- |- |
Start the app and tell the app how many exercises you want to do.|<img src="40_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 2 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
The app will show you the original title in Portuguese, the right<br>German title and some wrong movie titles (mostly with grammar errors, sometimes with spelling errors).<br>Your job is to find out the right German title.|<img src="80_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 3 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
By the way: the app connects to https://www.imdb.com , downloads a<br>picture and displays it as an ASCII Art.|<img src="160_800x800.png" width="400"/> |
